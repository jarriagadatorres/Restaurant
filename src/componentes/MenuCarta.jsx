...

{
    ...
    platos: [
        {
            plato: 'Soufflé de mango y coco',
            imagen: './src/assets/images/Souffle-mango.jpg',
            detalle: 'Soufflé clásico francés de base, combinado con trozos de mango y un topping de coco. ',
            precio: 10300
        },
        {
            plato: 'Mousse de frutas del bosque',
            imagen: './src/assets/images//Mousse-frutos.jpg',
            detalle: 'Cremoso postre en una versión con frutos del bosque, combinando el dulce y el ácido de forma deliciosa. ',
            precio: 10800
        },
        {
            plato: 'Pastel vegano de chocolate',
            imagen: './src/assets/images//Pastel-vegano.jpg',
            detalle: 'Bizcocho con chocolate de alto porcentaje de cacao, a partir de 70% por ejemplo, con mermelada de frambuesas. ',
            precio: 10200
        },
        {
            plato: 'Pie de limón con merengue XL',
            imagen: './src/assets/images//Pie-limon.jpg',
            detalle: 'Pie de limón con una capa grande y extra de merengue tamaño XL en su cobertura. ',
            precio: 12000
        }
    ]
}
